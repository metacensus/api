...
// The same literal as route-manifest.ts's apiPrefix. Unexported, so a star
// export of this file cannot collide with the manifest's.
const apiPrefixDefault = "/metacensus/api/v1";

// The same literal as route-manifest.ts's publicPrefix. Unexported, so a star
// export of this file cannot collide with the manifest's.
