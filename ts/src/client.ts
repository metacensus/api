...
// One batteries-included client per MetaCensus surface, over fetch. Client owns
// its HTTP: it holds the session token across login/logout and signs writes
// with an injected signer. Reads return flat views; the getXSigned variants
// return the signed envelope, for a caller verifying authorship. See
// README.md, "The generated client", and ts/README.md.
...
// the key stays in the closure. See ts/README.md, "Signing".
...
// The one place a request goes out. 2xx parses (an empty body is {}); anything
// else throws ApiError carrying the raw text.
