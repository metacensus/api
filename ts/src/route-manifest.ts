...
export const routes: readonly Route[] = [
  ...
  { prefix: apiPrefix, service: "PaperRoutes", rpc: "ListPapers", method: "POST", path: "/paper", params: [], query: [], body: "*", request: "PaperListRequest", response: "PaperList" },
  { prefix: apiPrefix, service: "PaperRoutes", rpc: "CreatePaper", method: "POST", path: "/paper/create", params: [], query: [], body: "*", request: "PaperCreateRequest", response: "Paper" },
  { prefix: apiPrefix, service: "PaperRoutes", rpc: "LookupPaper", method: "GET", path: "/paper/lookup", params: [], query: ["pmid"], body: "", request: "PaperLookupRequest", response: "PaperLookupResponse" },
