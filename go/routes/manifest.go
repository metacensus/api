...
// Prefix is the path metacensus.v1 routes hang off: the authenticated API.
//
...
// PublicPrefix is the path metacensus.public.v1 routes hang off: the public, unauthenticated surface.
//
// Join it with a Route's Path — a Route carries its own Prefix, so joining
// does not mean knowing which surface it came from.
